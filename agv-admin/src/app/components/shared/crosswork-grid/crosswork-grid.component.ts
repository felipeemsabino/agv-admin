...
@Component({
  selector: 'app-crosswork-grid',
  templateUrl: './crosswork-grid.component.html',
  styleUrls: ['./crosswork-grid.component.css']
})
export class CrossworkGridComponent implements OnInit {
  ...
  constructor(
              @Inject('IDataService') private providerService: IDataService[],
  ...
  */
  ...
  // Aplica a mascara de cpf na coluna do grid
  setCPFMask () {
  	$('.cpf').mask('000.000.000-00', {reverse: true});
  }

  // Reseta a mascara de cpf na coluna do grid
  resetMasks() {
  	setTimeout(function() {
